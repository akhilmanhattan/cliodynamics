...
<p>As the above example shows, your party, or atleast what other people percieve your party to be, can be decided by just one opinion on just one topic, even if your other opinions align with what the opinions party you like has. This example is better for Political Unity section, so I won't go into too much detail. Anyway, the question is why I used inverse immigration. The reason is because immigration generally means that ideas clash, and ideas and ideologies that are different can't just bind together in a single generation, but take generations to occur. Also, it generally means less jobs for the native-born population, which is great if you are building an army of rebels(or maybe just a cult-like following). Also, whenever the flow of immigrants decrease, the country is given breating space for the idoliogies and ideas(and cultures and cuisines too) to mesh together, which is the two way assimilation. For example, Irish-Americans used to be considered the lower-class people who were used as cannon fodder in politics and were of low "caste". However, the slowed immigration of the early 20th century allowed them to assimilate, bring their culture into mainstream American culture, and and even be proud of their heritage who can also be proud of being American. Anyway, that's it for this section, so onto the next!</p>

<h5 align="center">Political Unity</h5>

<p>During eras of high political unity, we tend to try and help everyone at once, as everyone tends to be on the same page regarding politics. This was the Great Society Reforms(it didn't go as well as everyone expected, but it had good intentions) of the 60s, as well as the increase in standard of living for people like slaves and  during the Era of Good Feelings. For example, slaves actually had better conditions after 1808 because of the ban on their importation, meaning that they had to be treated well so that they could have kids, and so that the plantation elite could still have kids. Also, many of the Founding Fathers had slaves, but they all thought that they should get rid of their slaves slowly. For farmers, you saw Jeffersonian Democracy which tried to represent them, and you also saw an increase in their wages. In the 60s, you saw desegregation and educational reforms. However, we are not living in those times today. Today, both parties take downtrodden groups(just people on the lower end of the payscale), as well as minorities, as cannon fodder for their politial plan(actually, the moderate wings of both parties aren't that bad, its mostly the "poles" that I'm really talking about). In the 60s, both parties supported civil rights(it was really only the South that opposed it), while during Emancipation, it was between Republicans and Democrats, with Republicans supporting it to get access to an untapped workforce, which is also one of the reasons they supported immigration(Republicans with the big business never changes). However, the constant polarization, moreso than the civil war, shows that the political parties are polarized using American citizens as cannon fodder. Another way to look at this is that the presidents represent their parties, not their country and its values(like the Bill of Rights). For example, one of the reasons JFK was so popular was because he embodied American values and supported change through Civil Rights; you don't see presidents like JFK today(or maybe someone like him exists, but they are just part of a third party). Anyway, let me point out some possible problems.

One problem is that the George Washington presidency is apparently heavily polarized. In order to fix this, I should probably try to add data from 1780-89 in order to bolster the accuracy of my model(this will be hard; how do you know who supported which side in the American revolution; I should probably ask the Lord Cornwallis himself). Another problem is that the civil war era doesn't look polarized enough(I mean, it looks like there wasn't that much polarization, and there was, although I would probably say there was more in the 1900s due to business interests and policies like immigration and other stuff that is somewhat similar to modern America's political divide). However, this could also be remedied with adding data from the 1780s, as the Washington Era(the starting) is pulling everyone down(so he isn't a hero; but actually, I would say he is because he was the only candidate almost everyone could agree upon; so the 1790s were definently polarized, but probably not as much as the graph makes it out to be). Another way to look at it is that we were polarized, but then unity sharply increased with Washington, which is what the graph says, and is quite consistent with history. Anyway, onto the next section!</p>
  
<a href="https://stream.org/the-left-sees-black-americans-as-cannon-fodder-captive-votes-and-cudgels-not-human-beings/">Today's "Civil Rights"</a>
...
<p>As you can see, the average line has trended downward, moreso than any other era that is seen on the graph. So, why is that? The answer probably has to do with a combination of a lack of wage growth and a lack of, well, every factor being at the peak they were in the 50s and 60s. This has generally meant that we could possibly be walking into a civil war, as all the factors are trending downwards like what happened right before the civil war. Also, because it is much lower, it could be more than a civil war, but a complete overhaul of the political system. The only time the line was this low was 1790, and it was probably lower during the Revolution, when there was a complete political overhaul. We could see a dictator take power(if that happens, better hope they are like George Washington), or a certain faction gain more federal power. This would greatly affect the world, so even if you aren't in America, these metrics and the recent trend with them could affect your life. The reason is because America guarantees world peace, and without America's stability, there could be  large scale conflict emerge as geopolitcal tensions aren't constantly overriden by America. Plus, the COVID crisis has really shown that when a crisis comes, America can't really respond properly(you could blame Trump for being too far on the right, but presidents like these really only come during times like these). So, how could things turn out if this civil war really happens? We should also examine why it may not happen.</p>
...
<p>If a civil war happens, it would probably start from the 2024 election, whether it be a debate on the issue of abortion, debt ceiling crisis, or a government shut down that results in a rebellion by the Military, who overthrows the government(actually, that sort of thing happens in countries that are preindustrial and extremely unequal, like Russia or France before their respective revolutions). Anyway, if it happens, it would probably just break out into mobs who would just fight eachother(the army would probably get in on the action, but I highly doubt they would make up most of the force in this civil war). It could be on a similar scale of the American Revolution, however, I think this ignores one fact: the strength of the federal government. When Britain wanted to impose its rule on America before the revolution, it was half an ocean away, and so there was less federal government power supressing the tensions(America's government is actually comparatively weak by historic standards, but things were just so good in America that there aren't that many large scale rebellions like you saw in the Warsaw Pact or in the Chinese Dynastic conflicts). However, one can see that the political situation isn't going well, and so I would probably expect a large scale civil conflict like that of the American Revolution(don't take it like an absolute prediction, it could be very wrong). If I am wrong, expect mass polarization and large scale political unrest.</p>
...
<a href="https://www.measuringworth.com/datasets/uswage/result.php">Hourly Worker Compensation from 1790(1789 is estimate, used it for growth statistic)</a>
